...
<meta name="theme-color" content="#563d7c">-->
    ...
    <link href="assets/styles/css/offcanvas.css" rel="stylesheet">
  </head>
  <body class="bg-light">
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
  <a class="navbar-brand mr-auto mr-lg-0" href="#">NEO Administration Version 1.0</a>
...
<?php
$pageOK = array(
  				  'photo' => 'include/selection.php',
				  'video' => 'include/selectionv.php',
				  'contenuphotos' => 'include/contenu.php',
				  'contenuvideos' => 'include/contenuv.php',
